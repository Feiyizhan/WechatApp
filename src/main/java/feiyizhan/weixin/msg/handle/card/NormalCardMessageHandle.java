 ...
 *
 */
public class NormalCardMessageHandle extends CardMessageHandle {
	private static final Logger LOGGER = LoggerFactory.getLogger(NormalCardMessageHandle.class);
	
	public NormalCardMessageHandle(UserSession session, AppControl control) {
